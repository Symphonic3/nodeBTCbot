...
function helpCommand(message, args) {
  ...
  message.channel.send(`Commands this bot accepts: ${commandList}. For bot support inquire at <http://bitcoindiscord.com/> or in the issues at <https://github.com/Symphonic3/nodeBTCbot/issues>`);
}
