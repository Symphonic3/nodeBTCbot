...
function helpCommand(message, args) {
  ...
  message.channel.send(`Commands this bot accepts: ${commandList}. For bot support inquire at <https://btcmaxis.com/discord> or in the issues at <https://github.com/Symphonic3/nodeBTCbot/issues>`);
}
